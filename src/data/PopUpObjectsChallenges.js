const PopUpObjectsChallenges = [
  {
    id: 0,
    text: "How might we reimagine scrubs for modern wearers with comfort and functionality in mind?",
    text2: "I chose to focus exclusively on users in the pet care industry, specifically groomers. The prototype you see has a removeable set of pockets similar to an apron with a waterproof space for electronics, and elements to provide temperature regulation, such as an integrated space for a hot/cold pack and grommets for breathability. I also created a collapsible hat with a mesh facial screen to keep hair out of the face when drying a double-coated pet."
  },
  {
    id: 1,
